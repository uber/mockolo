...
struct TypeParser {
    ...
    static private let defaultValuesDict =
        ["Int": "0",
         "Int64": "0",
         "Int32": "0",
         "Int16": "0",
    ...
    static private func defaultVal(typeName: String) -> String? {
    ...
    static private func parseBrackets(_ arg: String, left: String, right: String) -> String {
        var mutableArg = arg
    ...
    static private func parseParens(_ arg: String) -> String? {
        var stack = [[String]]()
    ...
    static private func lintCommas(_ arg: String) -> String {
    ...
    static func processDefaultVal(typeName: String, typeKeys: [String]? = nil) -> String? {
